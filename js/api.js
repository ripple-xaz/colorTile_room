...
var contractAddress = "n1wETHTrkQmq4k1UreqfkZmEuebEBfKYWvX" //项目合约地址
var nickNameAddress = "n1gHbworeeX9Q3Png44YysZDWpxbmyoXDw2"  //拉去昵称的合约地址
var userAddress = '' //用户钱包地址，默认为空


function onSimulateCallClick(contractAddress,value,callFunction,callArgs,callback) {  //call查询调用函数，（合约地址，函数名，参数，回调）
...
function newTransaction(contractAddress,value,callFunction,callArgs,callback) {  //合约交易调用函数，（合约地址，函数名，参数，回调）
